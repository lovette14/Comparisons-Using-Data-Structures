        ...
        if self._count >= ( Hash_Set._LOAD_FACTOR * self._slots): #
            ...
            if p == -1:
                ...
                if self._table[hash_value] is None:
                    self._table[hash_value]= deepcopy(value)
                    
                else:
                    self._table[hash_value].insert(deepcopy(value))
    ...
    def remove(self, key):
        ...
        if self._count!=0 :
            ...
            if key in self._table[hash_key]:
                value = self._table[hash_key].pop(key)
        ...
        for q in n:
            ...
            if p == -1:              
                ...
                if self._table[hash_value] is None:
                    ...
                    self._table[hash_value].insert(deepcopy(q))
        return
