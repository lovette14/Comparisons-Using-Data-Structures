...
class List:
    ...
    def _linear_search(self, key):
        ...
        while count < n and self._values[count] != key:
            count += 1
    ...
    def clean(self):
        ...
        while i< len(self._values):
            ...
            if self._values[i] not in t:
                t.append(self._values[i])
    ...
    def combine(self, source1, source2):
        ...
        """
        # Your code here
        n = len(source1._values)
        p = len(source2._values)
        ...
        while n!= 0 or p!= 0:
            ...
            if n != 0:
                ...
                source1._values = source1._values[1:]
                n = len(source1._values)

            if p!= 0:
                y = source2._values[0]
                self._values.append(y)
                source2._values = source2._values[1:]
                p = len(source2._values)
        return
    ...
    def insert(self, i, value):
        ...
        if -n <=  i <= (n-1 ):
            ...
            if i >= 0: 
                self._values = self._values[:i+1] + self._values[i:n]
                self._values[i] = deepcopy(value)
                
            else:
                
                self._values = self._values[:] + [self._values[n-1]]
                self._values[n-1] = deepcopy(value)
            ...
            if i < 0:
                ...
                self._values = [self._values[0]] + self._values[0:]
